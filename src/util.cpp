...
int nAnonymizeeonagenAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\eonagen
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\eonagen
    // Mac: ~/Library/Application Support/eonagen
    // Unix: ~/.eonagen
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "eonagen";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "eonagen.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "eonagend.pid"));
